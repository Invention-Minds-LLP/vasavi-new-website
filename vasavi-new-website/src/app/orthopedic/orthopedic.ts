...
export class Orthopedic {
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({namre:'description', content:'Advanced orthopedic care at Vasavi Hospitals in Banashankari Bangalore. Joint replacement, bone care, and robotic knee surgery.'})
  }
