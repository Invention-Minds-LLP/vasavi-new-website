 ...
 * clean/no baked-in text or price) is live in public/img/packages/tkr/ -
 ...
 * already exists sitewide flat at public/img/packages/ and is wired in below
...
export class RoboticTkrComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly heroAssetBase = 'img/packages/tkr';
