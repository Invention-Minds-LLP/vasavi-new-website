 ...
 * public/img/packages/acl-reconstruction/ - see the `heroAsset()` calls in
 ...
 * public/img/packages/ and is wired in below via a literal path.
 */
@Component({
...
export class ACLReconstructio implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly heroAssetBase = 'img/packages/acl-reconstruction';
