 ...
 * public/img/packages/gallstone-removal/ - see the `heroAsset()` calls in
 ...
 * at public/img/packages/ and is wired in below via a literal path.
 */
@Component({
...
export class RoboticCholecystectomyComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly heroAssetBase = 'img/packages/gallstone-removal';
