 ...
 * public/img/packages/adenoid-removal/ - see heroAsset() calls in the
 ...
 * a breakpoint.
 *
 * adenoid-video.mp4 already exists sitewide at public/img/packages/ (flat,
...
export class AdenoidRemoval implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly heroAssetBase = 'img/packages/adenoid-removal';
  private readonly assetBase = 'img/packages/adenoid-removal';
