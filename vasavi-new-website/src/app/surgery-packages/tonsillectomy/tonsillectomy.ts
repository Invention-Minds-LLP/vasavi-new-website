 ...
 * live in public/img/packages/tonsillectomy-surgery/ - see the `heroAsset()`
 ...
 * into a breakpoint.
 * A tonsil-video.mp4 already exists sitewide at public/img/packages/ and is
...
export class Tonsillectomy implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly heroAssetBase = 'img/packages/tonsillectomy-surgery';
  private readonly assetBase = 'img/packages/tonsillectomy-surgery';
