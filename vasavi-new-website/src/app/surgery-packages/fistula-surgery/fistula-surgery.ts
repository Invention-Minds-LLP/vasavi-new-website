 ...
 * public/img/packages/fistula-surgery/ - see the `heroAsset()` calls in the
 ...
 * public/img/packages/ and is wired in below via a literal path, same
...
export class FistulaSurgery implements OnInit, AfterViewInit, OnDestroy {
  ...
  private readonly heroAssetBase = 'img/packages/fistula-surgery';
