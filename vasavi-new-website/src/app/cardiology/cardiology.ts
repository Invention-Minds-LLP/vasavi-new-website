...
export class Cardiology {
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({name:'description', content:'Leading heart hospital in Banashankari Bangalore with Cath Lab, experienced cardiologists, and 24/7 emergency cardiac care.'})
  }
