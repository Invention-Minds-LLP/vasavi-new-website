...
export class Urology {
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({name:'description', content:'Vasavi Hospitals in Banashankari Bangalore offers expert urology treatments for kidney stones, bladder, and prostate health.'})
  }
