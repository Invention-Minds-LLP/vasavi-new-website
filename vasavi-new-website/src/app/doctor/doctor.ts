  ...
  allDoctors = [
    ...
    },
    {
      ...
      areasOfExpertise: [
        ...
        { icon: "", expertise: "Pleuroscopy" },
        { icon: "", expertise: "EBUS" },
        { icon: "", expertise: "Lung Biopsies" },
      ],
      title: "Dr. Manjunath P. H | Pulmonologist & Interventional Lung Specialist in Bengaluru",
      description: "Dr. Manjunath P. H is a pulmonologist with over 8 years of experience, specializing in interventional pulmonology and interstitial lung diseases. He has expertise in advanced procedures such as bronchoscopy, EBUS, pleuroscopy, and lung biopsies, and is committed to providing accurate diagnosis and comprehensive respiratory care.",
      briefProfile: "Dr. Manjunath P H graduated from BMC & RI bengaluru and NH Bengaluru. He is practising in the field of pulmonology for the past 8 years. His areas of interest are Intervention Pulmonology and Interstitial lung diseases. He has performed numerous procedures in his career including bronchoscopy, pleuroscopy, EBUS and Lung biopsies. He has multiple publications in national and international journals. He has given talks on various topics in his field on various forums.",
    ...
    },
    {
      ...
      areasOfExpertise: [
        ...
        { icon: "", expertise: "Holistic Care" },
        { icon: "", expertise: "Outpatient Department (OPD)" },
        { icon: "", expertise: "Anemia Workup" },
        { icon: "", expertise: "UGI Endoscopy" },
        { icon: "", expertise: "Infections - GERD (acid reflux) and dysphagia" },
        { icon: "", expertise: "UGI Bleed Management" },
        { icon: "", expertise: "Esophageal Variceal Banding" },
        { icon: "", expertise: "Liver Care - Jaundice, Hepatitis, Cirrhosis, HCC" },
        { icon: "", expertise: "Gallbladder Stones" },
        { icon: "", expertise: "Cholecystitis - DILI" },
        { icon: "", expertise: "Pancreatitis - Acute & Chronic" },
        { icon: "", expertise: "Chronic Diarrhea" },
        { icon: "", expertise: "Bleeding Per Rectum" },
        { icon: "", expertise: "Colonoscopy" },
        { icon: "", expertise: "Sigmoidoscopy" },
      ],
      title: "Dr. Akshay Masur | Consultant Internal Medicine & Gastroenterology Specialist at Vasavi Hospitals Bangalore",
