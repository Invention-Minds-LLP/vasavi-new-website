...
@Component({
  ...
  imports: [CallbackForm, DoctorsCard, CommonModule, PopUpFormAds],
  templateUrl: './robotic-hernia.html',
  styleUrl: './robotic-hernia.css'
})
export class RoboticHernia {
...
herniaTypes: HerniaType[] = [
  {
    ...
    description: 'Occurs in the groin when tissue pushes through a weak spot in the abdominal wall. Common in men.',
