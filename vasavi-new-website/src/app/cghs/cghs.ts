 ...
 *  - Palette sampled from public/img/logo/vasavi-new-logo.png: #2E3192 indigo
 ...
 *  - The banner set in public/img/cghs/ is now wired up (it was authored for
...
export class Cghs implements OnInit, OnDestroy {
  ...
  /**
   * Hero banner tiers live in public/img/cghs/ (mobile / tablet / 1024 /
   * desktop, WebP, no baked-in text). Same helper shape as the surgery
   * pages so the two stay swappable.
   */
  private readonly heroAssetBase = 'img/cghs';
