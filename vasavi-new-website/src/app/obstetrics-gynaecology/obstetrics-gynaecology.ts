...
export class ObstetricsGynaecology {
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({name:'description', content:'Women’s health and maternity care in Banashankari Bangalore. Safe pregnancy, gynecology services, and expert obstetricians.'})
  }
